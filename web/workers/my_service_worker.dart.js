...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    MyServiceImpl__heavyMethod(n) {
      var i, result, e;
      for (i = 0, result = ""; i < n;) {
        result += B.JSInt_methods.toRadixString$1(A.MyServiceImpl__getNth(i), 16);
        ++i;
        if (i >= n)
          break;
      }
      e = A.RangeError_checkValidRange(1, 1, result.length);
      return result.substring(0, 1) + "." + result.substring(e);
    },
    MyServiceImpl__getNth(n) {
      var x;
      --n;
      x = 4 * A.MyServiceImpl__piTerm(1, n) - 2 * A.MyServiceImpl__piTerm(4, n) - A.MyServiceImpl__piTerm(5, n) - A.MyServiceImpl__piTerm(6, n);
      return B.JSNumber_methods.toInt$0((x - B.JSNumber_methods.floor$0(x)) * 16);
    },
    MyServiceImpl__piTerm(j, n) {
      var r, s, k, t, newt;
      for (r = j, s = 0, k = 0; k <= n; ++k) {
        s += A.MyServiceImpl__powMod(16, n - k, r) / r;
        s -= B.JSNumber_methods.floor$0(s);
        r += 8;
      }
      k = n + 1;
      r = 8 * k + j;
    ...
    MyServiceImpl__powMod(a, b, m) {
      ...
      if (b === 0)
        ...
        temp = A.MyServiceImpl__powMod(a, B.JSInt_methods._tdivFast$1(b, 2), m);
        t1 = temp * temp;
        tempo = B.JSInt_methods.$mod(b, 2) === 0 ? B.JSInt_methods.$mod(t1, m) : B.JSInt_methods.$mod(B.JSInt_methods.$mod(t1, m) * a, m);
      }
      return tempo;
    },
    MyServiceImpl: function MyServiceImpl() {
      this.__MyServiceImpl_operations = $;
    },
    MyServiceImpl_operations_closure: function MyServiceImpl_operations_closure(t0) {
      this.$this = t0;
    },
    main() {
    ...
    WorkerRunner_processMessage_closure0: function WorkerRunner_processMessage_closure0(t0, t1, t2) {
      this.$this = t0;
      this.tokenRef = t1;
      this.streamId = t2;
    },
  ...
  A.MyServiceImpl.prototype = {
    computeHeavyMethod$1(n) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.String),
        $async$returnValue;
      var $async$computeHeavyMethod$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$returnValue = A.MyServiceImpl__heavyMethod(n);
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      return A._asyncStartSync($async$computeHeavyMethod$1, $async$completer);
    },
    get$operations() {
      var result, _this = this,
        value = _this.__MyServiceImpl_operations;
      if (value === $) {
        result = A.LinkedHashMap_LinkedHashMap$_literal([1, new A.MyServiceImpl_operations_closure(_this)], type$.int, type$.dynamic_Function_WorkerRequest);
        if (_this.__MyServiceImpl_operations !== $)
          A.throwLateFieldADI("operations");
        _this.set$__MyServiceImpl_operations(result);
        value = result;
      }
      return value;
    },
    set$__MyServiceImpl_operations(__MyServiceImpl_operations) {
      this.__MyServiceImpl_operations = type$.Map_of_int_and_dynamic_Function_WorkerRequest._as(__MyServiceImpl_operations);
    },
    $isWorkerService: 1
  };
  A.MyServiceImpl_operations_closure.prototype = {
    call$1(r) {
      return this.$this.computeHeavyMethod$1(A._asInt(J.$index$ax(type$.WorkerRequest._as(r).args, 0)));
    },
    $signature: 22
  };
  A.main_closure.prototype = {
    call$1(_) {
      return new A.MyServiceImpl();
    },
    $signature: 23
  };
  ...
  A.WorkerRunner.prototype = {
    ...
    processMessage$body$WorkerRunner(message) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.dynamic),
        $async$returnValue, $async$handler = 2, $async$currentError, $async$next = [], $async$self = this, tokenRef, op, result, inspectResponse, subscription, done, shutdown, streamId, e, st, t2, tokenRef0, t3, t4, cancellers, t5, action, exception, request, t1, client, $async$exception;
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 10:
              ...
              t5 = t4._eval$1("~(1)?")._as(new A.WorkerRunner_processMessage_closure(client, inspectResponse));
              type$.nullable_void_Function._as(shutdown);
              t4 = A._EventStreamSubscription$(t3._target, t3._eventType, t5, false, t4._precomputed1);
              ...
              t2.__late_helper$_value = t4;
              t2 = done.future;
              action = type$.dynamic_Function._as(new A.WorkerRunner_processMessage_closure0($async$self, tokenRef, streamId));
              t3 = t2.$ti;
              result = new A._Future($.Zone__current, t3);
              t2._addListener$1(new A._FutureListener(result, 8, action, null, t3._eval$1("@<1>")._bind$1(t3._precomputed1)._eval$1("_FutureListener<1,2>")));
              $async$goto = 13;
              return A._asyncAwait(result, $async$processMessage$1);
            case 13:
              // returning from await.
  ...
  (function installTearOffs() {
    ...
    var _;
    _instance_1_u(_ = A.Transferables.prototype, "get$_isBaseType", "_isBaseType$1", 3);
    _instance_1_u(_, "get$_isSafeForTransfer", "_isSafeForTransfer$1", 3);
  })();
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.Closure, A.Iterable, A.ListIterator, A.Iterator, A.ExpandIterator, A.EmptyIterator, A.FixedLengthListMixin, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A.ExceptionAndStackTrace, A._StackTrace, A.MapMixin, A.LinkedHashMapCell, A.LinkedHashMapKeyIterator, A._Cell, A.Rti, A._FunctionParameters, A._TimerImpl, A._AsyncAwaitCompleter, A._IterationMarker, A._SyncStarIterator, A.AsyncError, A._Completer, A._FutureListener, A._Future, A._AsyncCallbackEntry, A.Stream, A.StreamSubscription, A.StreamTransformerBase, A._StreamIterator, A._Zone, A.__SetBase_Object_SetMixin, A._LinkedHashSetCell, A._LinkedHashSetIterator, A.ListMixin, A.SetMixin, A.Codec, A._JsonStringifier, A.DateTime, A.OutOfMemoryError, A.StackOverflowError, A._Exception, A.Null, A._StringStackTrace, A.StringBuffer, A.EventStreamProvider, A._StructuredClone, A._AcceptStructuredClone, A.NullRejectionException, A.MyServiceImpl, A._BaseJsChannel, A.Transferables, A.CancellationToken, A.Squadron, A.SquadronError, A.SquadronException, A.BaseSquadronLogger, A.WorkerRequest, A.WorkerResponse, A.SequenceId, A.WorkerMonitor, A.WorkerRunner]);
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.JsLinkedHashMap_values_closure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._awaitOnObject_closure, A._Future__chainForeignFuture_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A.Stream_length_closure, A._RootZone_bindUnaryCallbackGuarded_closure, A._EventStreamSubscription_closure, A.promiseToFuture_closure, A.promiseToFuture_closure0, A.MyServiceImpl_operations_closure, A.main_closure, A.bootstrap_closure0, A.bootstrap_closure1, A.Transferables__getObjects_closure, A.BaseSquadronLogger__log_closure, A.BaseSquadronLogger__log_closure0, A.BaseSquadronLogger__log_closure1, A.BaseSquadronLogger__log_closure2, A.WorkerRunner_connect_closure, A.WorkerRunner_processMessage_closure]);
    _inheritMany(A.Closure0Args, [A.nullFuture_closure, A._AsyncRun__scheduleImmediateJsOverride_internalCallback, A._AsyncRun__scheduleImmediateWithSetImmediate_internalCallback, A._TimerImpl_internalCallback, A._Future__addListener_closure, A._Future__prependListeners_closure, A._Future__chainForeignFuture_closure1, A._Future__asyncCompleteWithValue_closure, A._Future__chainFuture_closure, A._Future__asyncCompleteError_closure, A._Future__propagateToListeners_handleWhenCompleteCallback, A._Future__propagateToListeners_handleValueCallback, A._Future__propagateToListeners_handleError, A.Stream_length_closure0, A._rootHandleError_closure, A._RootZone_bindCallbackGuarded_closure, A.bootstrap_closure, A._JsWorkerChannel_error_closure, A.WorkerMonitor__getTokenRef_closure, A.WorkerRunner_processMessage_shutdown, A.WorkerRunner_processMessage_closure0]);
...
//# sourceMappingURL=my_service_worker.dart.js.map
